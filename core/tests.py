...
class DBTestCase(TestCase):
	...
	def setUp(self):
		ContentSearchIndex.objects.using('search_db').create(url="https://www.starwars.com/", title="Star Wars",
															 description="star Wars Site", site_lang="en",
															 site_content="About Star Wars", keywords="star wars")
		ContentSearchIndex.objects.using('search_db').create(url="https://www.google.com/", title="Google",
															 description="Google Site", site_lang="en",
															 site_content="Google search engine",
